...
//
// The "dominant" median-cut method (see deriveColors) picks the largest
// quantised bucket as the background and the highest contrast×vividness bucket
// as the text. A shared final pass enforces the panel sliders (saturation,
// min-contrast): the text is pushed until it meets a WCAG contrast ratio
// against the background. The method tries to extract all three colours from
// the artwork, including the outline; when no suitable third colour is found,
// the outline falls back to a near-black/near-white edge legible against the
// text.
//
 ...
 * synthetic black/white edge. Returns hex strings.
 */
