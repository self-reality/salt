...
export function buildEntryFromDatasetItem(entry) {
  ...
  // Optional fields the dev pages (label.js) substitute into the datamatrix and
  // description; scenes/prerender ignore the extra keys.
  ...
  return { username, name, width, height, filename, avatar, description, contractAddress, tokenId };
}
